...
productivity without harming readability.  `hpre` was [originally
written in Haskell](https://github.com/galenhuntington/hpre), but I
ported it to Rust for version 4.0.
